    ...
    <div class="mx-auto max-w-6xl space-y-6">
      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            <div class="flex flex-wrap items-center justify-between gap-4 px-6 py-5">
              ...
              <router-link to="/admin/menu" class="btn btn-primary">
        ...
        <div v-show="activeTab === 'payment'" class="space-y-6">
          ...
          <!-- Provider Management removed: /admin/payment/providers is not registered -->
        </div>
...
const form = reactive<SettingsForm>({
  ...
  // Comma/newline-separated built-in menu paths to hide from sidebar, e.g. "/usage,/admin/ops"
  hidden_menu_keys: [] as string[],
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      hidden_menu_keys: form.hidden_menu_keys,
