...
describe("admin SettingsView payment visible method controls", () => {
  ...
  it.skip("updates provider enablement immediately and reloads providers (payment providers API removed)", async () => {
    const provider = {
      id: 7,
      provider_key: "alipay",
  ...
  it.skip("normalizes null supported_types from API so provider card stays visible (payment providers API removed)", async () => {
