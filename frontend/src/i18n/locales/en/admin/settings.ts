    ...
    settings: {
      ...
      features: {
        ...
        modelPlaza: {
          ...
          enabledHint: 'When enabled, an entry appears in the header and the page is reachable at /model-plaza. The admin sidebar entry is controlled by Menu Management and ignores this switch.',
