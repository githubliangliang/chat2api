export default {
    ops: {
      ...
      errorLog: {
        ...
        action: 'Action',
        cleanupAll: 'Cleanup',
        cleanupAllConfirm: 'Delete all error logs? This action cannot be undone.',
        cleanupAllSuccess: 'Cleanup complete. Deleted {count} error logs.',
        cleanupAllFailed: 'Failed to clean up error logs',
