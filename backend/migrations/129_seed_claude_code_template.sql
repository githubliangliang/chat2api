-- [sqlite-converted] from PostgreSQL migration: 129_seed_claude_code_template.sql
...
--   3) metadata.user_id 满足 ParseMetadataUserID — 这里用 legacy 格式（user_<64hex>_account_<TEXT>_session_<36char>）
