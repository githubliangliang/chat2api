-- [sqlite-converted] from PostgreSQL migration: 038_ops_errors_resolution_retry_results_and_standardize_classification.sql
...
ALTER TABLE ops_error_logs ADD COLUMN resolved_retry_id BIGINT;
...
ALTER TABLE ops_retry_attempts ADD COLUMN success BOOLEAN;

ALTER TABLE ops_retry_attempts ADD COLUMN http_status_code INT;

ALTER TABLE ops_retry_attempts ADD COLUMN upstream_request_id VARCHAR(128);

ALTER TABLE ops_retry_attempts ADD COLUMN used_account_id BIGINT;

ALTER TABLE ops_retry_attempts ADD COLUMN response_preview TEXT;

ALTER TABLE ops_retry_attempts ADD COLUMN response_truncated BOOLEAN NOT NULL DEFAULT false;
