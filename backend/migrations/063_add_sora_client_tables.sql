-- [sqlite-converted] from PostgreSQL migration: 063_add_sora_client_tables.sql
...
-- ============================================================
ALTER TABLE users ADD COLUMN sora_storage_quota_bytes BIGINT NOT NULL DEFAULT 0;
ALTER TABLE users ADD COLUMN sora_storage_used_bytes  BIGINT NOT NULL DEFAULT 0;

-- ============================================================
-- 3. groups 表新增 Sora 存储配额字段
-- ============================================================
ALTER TABLE groups ADD COLUMN sora_storage_quota_bytes BIGINT NOT NULL DEFAULT 0;
