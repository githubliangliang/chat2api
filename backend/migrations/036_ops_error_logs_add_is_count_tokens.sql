-- [sqlite-converted] from PostgreSQL migration: 036_ops_error_logs_add_is_count_tokens.sql
...
ALTER TABLE ops_error_logs ADD COLUMN is_count_tokens BOOLEAN NOT NULL DEFAULT FALSE;
