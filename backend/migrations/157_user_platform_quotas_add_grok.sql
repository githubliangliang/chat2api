-- [sqlite-converted] from PostgreSQL migration: 157_user_platform_quotas_add_grok.sql
...
-- [sqlite] DROP CONSTRAINT user_platform_quotas_platform_check on user_platform_quotas → try DROP INDEX
DROP INDEX IF EXISTS user_platform_quotas_platform_check;
