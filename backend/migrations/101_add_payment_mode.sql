-- [sqlite-converted] from PostgreSQL migration: 101_add_payment_mode.sql
...
SET payment_mode = 'redirect',
    supported_types = trim(REPLACE(REPLACE(REPLACE(supported_types, 'easypay,', ''), ',easypay', ''), 'easypay', ''), ',')
