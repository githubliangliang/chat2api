-- [sqlite-converted] from PostgreSQL migration: 037_add_account_rate_multiplier.sql
...
ALTER TABLE accounts ADD COLUMN rate_multiplier DECIMAL(10,4) NOT NULL DEFAULT 1.0;

ALTER TABLE usage_logs ADD COLUMN account_rate_multiplier DECIMAL(10,4);
