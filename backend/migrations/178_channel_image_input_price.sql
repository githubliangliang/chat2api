-- [sqlite-converted] from PostgreSQL migration: 178_channel_image_input_price.sql
...
ALTER TABLE channel_model_pricing ADD COLUMN image_input_price NUMERIC(20,12);
