-- [sqlite-converted] from PostgreSQL migration: 033_ops_monitoring_vnext.sql
...
-- Hourly table
ALTER TABLE ops_metrics_hourly ADD COLUMN duration_avg_ms REAL;
ALTER TABLE ops_metrics_hourly ADD COLUMN duration_max_ms INT;
ALTER TABLE ops_metrics_hourly ADD COLUMN ttft_avg_ms REAL;
ALTER TABLE ops_metrics_hourly ADD COLUMN ttft_max_ms INT;

-- Daily table
ALTER TABLE ops_metrics_daily ADD COLUMN duration_avg_ms REAL;
ALTER TABLE ops_metrics_daily ADD COLUMN duration_max_ms INT;
ALTER TABLE ops_metrics_daily ADD COLUMN ttft_avg_ms REAL;
ALTER TABLE ops_metrics_daily ADD COLUMN ttft_max_ms INT;
...
ALTER TABLE ops_alert_rules ADD COLUMN notify_email BOOLEAN NOT NULL DEFAULT true;
...
INSERT INTO ops_alert_rules (
    ...
    true, 'error_rate', '>', 5.0, 5, 5, 'P1', true, 20, datetime('now'), datetime('now')
...
INSERT INTO ops_alert_rules (
    ...
    true, 'success_rate', '<', 95.0, 5, 5, 'P0', true, 15, datetime('now'), datetime('now')
) ON CONFLICT (name) DO NOTHING;
...
INSERT INTO ops_alert_rules (
    ...
    true, 'p99_latency_ms', '>', 3000.0, 5, 10, 'P2', true, 30, datetime('now'), datetime('now')
) ON CONFLICT (name) DO NOTHING;
...
INSERT INTO ops_alert_rules (
    ...
    true, 'p95_latency_ms', '>', 2000.0, 5, 10, 'P2', true, 30, datetime('now'), datetime('now')
) ON CONFLICT (name) DO NOTHING;
...
INSERT INTO ops_alert_rules (
    ...
    true, 'cpu_usage_percent', '>', 85.0, 5, 10, 'P2', true, 30, datetime('now'), datetime('now')
) ON CONFLICT (name) DO NOTHING;
...
INSERT INTO ops_alert_rules (
    ...
    true, 'memory_usage_percent', '>', 90.0, 5, 10, 'P1', true, 20, datetime('now'), datetime('now')
) ON CONFLICT (name) DO NOTHING;
...
INSERT INTO ops_alert_rules (
    ...
    true, 'concurrency_queue_depth', '>', 100.0, 5, 5, 'P1', true, 20, datetime('now'), datetime('now')
) ON CONFLICT (name) DO NOTHING;
...
INSERT INTO ops_alert_rules (
    ...
    true, 'error_rate', '>', 20.0, 1, 1, 'P0', true, 15, datetime('now'), datetime('now')
) ON CONFLICT (name) DO NOTHING;

-- Ops Monitoring vNext: add Redis pool stats fields to system metrics snapshots.
-- This migration is intentionally idempotent.

ALTER TABLE ops_system_metrics ADD COLUMN redis_conn_total INT;
ALTER TABLE ops_system_metrics ADD COLUMN redis_conn_idle INT;
